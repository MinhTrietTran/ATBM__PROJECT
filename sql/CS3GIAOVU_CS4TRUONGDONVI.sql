...
AS SELECT* FROM CAMPUSADMIN.PHANCONG WHERE MAHP IN (SELECT MAHP FROM CAMPUSADMIN.HOCPHAN WHERE MADV = (SELECT MADV FROM CAMPUSADMIN.DONVI WHERE TENDV = N'V?n ph�ng khoa'));
/
...
-- GIAO VU
GRANT SELECT, INSERT, UPDATE ON CAMPUSADMIN.SINHVIEN TO GIAOVU;
GRANT SELECT, INSERT, UPDATE ON CAMPUSADMIN.DONVI TO GIAOVU;
GRANT SELECT, INSERT, UPDATE ON CAMPUSADMIN.KHMO TO GIAOVU;
GRANT SELECT, UPDATE, INSERT ON CAMPUSADMIN.HOCPHAN TO GIAOVU;
...
GRANT SELECT ON CAMPUSADMIN.UV_SELDANGKY_4TEST TO TRUONGDONVI;
...
GRANT SELECT ON CAMPUSADMIN.UV_SELDANGKY TO TRUONGDONVI;    
GRANT SELECT ON CAMPUSADMIN.UV_SELDANGKY_4TEST TO TRUONGDONVI;
GRANT INSERT ON CAMPUSADMIN.DANGKY TO TRUONGDONVI;
GRANT DELETE ON CAMPUSADMIN.DANGKY TO TRUONGDONVI;
