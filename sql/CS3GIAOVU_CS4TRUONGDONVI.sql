...
AS SELECT* FROM CAMPUSADMIN.PHANCONG WHERE MAHP IN (SELECT MAHP FROM CAMPUSADMIN.HOCPHAN WHERE MADV = (SELECT MADV FROM CAMPUSADMIN.DONVI WHERE TENDV = N'V?n phòng khoa'));
/
